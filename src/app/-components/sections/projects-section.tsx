            ...
            <div className="flex flex-col gap-2 sm:flex-row justify-between">
              ...
              <div className="flex flex-wrap gap-2">
                <a
                  ...
                  className="flex items-center gap-2 animated-link"
                >
                  View on npm{" "}
                  <svg
                    width="15"
        ...
        <div className="flex flex-col gap-y-8">
          <div className="lora-400">
            <div className="flex flex-col gap-2 sm:flex-row justify-between">
              ...
              <div className="flex flex-wrap gap-2">
                <a
                  href="https://github.com/nonameprogram/portfolio"
                  className="flex items-center gap-2 animated-link"
                >
                  View on GitHub{" "}
                  <svg
            ...
            <PillGroup items={["Next.js", "Motion", "React", "TailwindCSS"]} />
            <div className="inter-400 mt-6">
              A personal portfolio built with Next.js and React to showcase
              projects and experience. It features smooth animations with Motion
