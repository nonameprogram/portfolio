...
const Pill = ({ text }: { text: string }) => (
  <div className="bg-neutral-900 py-1 px-3 lora-400 hover:bg-neutral-300 hover:text-black transition-colors duration-300">
    {text}
  </div>
);
...
export default function Page() {
  return (
    <motion.div
      className="relative flex flex-col bg-neutral-900 w-full"
      whileInView={{ scale: 0.8, borderRadius: "2rem" }}
    >
      <div className="px-8 container xl:mx-auto pb-24 flex flex-col gap-16 relative grow">
        <div className="flex gap-x-4 relative">
          <div className="grid grid-cols-3 gap-24 relative">
            <div className="col-span-3 xl:col-span-2 space-y-24 pt-24">
              <div className="space-y-16">
                ...
                >
                  <div className="lora-400 text-4xl" id="about-me">
                    01 / About Me
                  </div>
                ...
                {/*>*/}
                {/*  <div className="lora-400 text-4xl" id="about-me--tech-stack">*/}
                {/*    Tech Stack*/}
                {/*  </div>*/}
                {/*  <div className="flex flex-col gap-y-4">*/}
                {/*    <div className="flex gap-2 items-center flex-wrap">*/}
                {/*      <div className="lora-400">Backend</div>*/}
                {/*      <Pill text="NestJS" />*/}
                {/*      <Pill text="Next.js" />*/}
                {/*      <Pill text="Laravel" />*/}
                {/*      <Pill text="MySQL" />*/}
                ...
                {/*    </div>*/}
                {/*    <div className="flex gap-2 items-center flex-wrap">*/}
                {/*      <div className="lora-400">Frontend</div>*/}
                {/*      <Pill text="React" />*/}
                {/*      <Pill text="Redux" />*/}
                ...
                {/*    </div>*/}
                {/*    <div className="flex gap-2 items-center flex-wrap">*/}
                {/*      <div className="lora-400">Tests</div>*/}
                {/*      <Pill text="Jest" />*/}
                {/*      <Pill text="React Testing Library" />*/}
                {/*      <Pill text="Vitest" />*/}
                {/*      <Pill text="PHPUnit" />*/}
                {/*      <Pill text="Playwright" />*/}
                {/*    </div>*/}
                {/*    <div className="flex gap-2 items-center flex-wrap">*/}
                {/*      <div className="lora-400">Language and Tools</div>*/}
              ...
              <div className="space-y-16">
                <motion.div
                  ...
                  transition={{ duration: 1 }}
                >
                  <div className="lora-400 text-4xl" id="work-experience">
                    02 / Experience
                  </div>
                  <div className="flex flex-col gap-y-8">
            ...
            <div className="hidden xl:block sticky top-0 text-neutral-300 text-lg h-max pt-24">
              <ul className="space-y-2">
                ...
                <ul className="border-l pl-4 py-1 border-l-neutral-800">
                  <li className="lora-400 text-base">
                    <a href="#about-me--tech-stack" className="hover:underline">
                      Tech Stack
                    </a>
                  </li>
                </ul>
