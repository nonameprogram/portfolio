    ...
    <div className="flex flex-col">
      ...
      >
        ...
        >
          ...
          <div className="container relative mx-auto flex h-full w-full flex-col gap-16 px-6 py-12 md:px-12">
            <div className="relative grid h-full w-full grid-cols-1 justify-center gap-y-8 xl:grid-cols-2">
              ...
              >
                <div className="relative flex w-full flex-col items-center md:items-start">
                  ...
                  <div className="lora-400 relative z-20 space-x-2 space-y-4 p-8 text-3xl xl:text-4xl">
              ...
              <div className="grid h-full w-full grid-cols-2 grid-rows-3 gap-2 xl:grid-cols-3">
                  ...
                  >
                    <div className="relative flex h-full flex-col">
                      ...
                      <div className="absolute top-0 right-0 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                        <BrainIcon className="size-12" strokeWidth={1} />
                      </div>
                    </div>
                  </motion.div>
                </button>
                ...
                >
                  <div className="relative flex h-full flex-col">
                    ...
                    <div className="absolute top-0 right-0 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      <LayersIcon className="size-12" strokeWidth={1} />
                    </div>
                  </div>
                </motion.button>
                <motion.button
                ...
                >
                  <div className="relative flex h-full flex-col">
                    ...
                    <div className="absolute top-0 right-0 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      <RocketIcon className="size-12" strokeWidth={1} />
                    </div>
                  </div>
                </motion.button>
                <motion.button
                ...
                >
                  <div className="relative flex h-full flex-col">
                    ...
                    <div className="absolute top-0 right-0 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      <MailIcon className="size-12" strokeWidth={1} />
                    </div>
                  </div>
                </motion.button>
              </div>
